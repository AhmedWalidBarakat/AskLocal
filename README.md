...
Swap in any set of PDFs — internal wikis, policy manuals, technical documentation, research papers — re-run `ingest.py`, and the chatbot answers questions grounded in that new content, still without any data leaving the machine.
